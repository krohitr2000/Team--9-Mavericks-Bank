...
namespace MavericksBank.Controllers
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public TransactionsController(MavericksBankDb2Context context)
        {
            _context = context;
        }

        // GET: api/Transactions/ByAccountId/{accountId}
        ...
        public async Task<ActionResult<Transaction>> PostTransaction(Transaction transaction)
        {
          if (_context.Transactions == null)
          {
              return Problem("Entity set 'MavericksBankDb2Context.Transactions'  is null.");
          }
